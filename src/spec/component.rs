...
pub struct Components {
    ...
    pub schemas: Map<String, RefOr<Either<schemars::Schema, MultiFormatSchema>>>,
    /// An object to hold reusable [Server Objects](Server).
    #[serde(default, skip_serializing_if = "Map::is_empty")]
    pub servers: Map<String, RefOr<Server>>,
    /// An object to hold reusable [Channel Objects](Channel).
    #[serde(default, skip_serializing_if = "Map::is_empty")]
    pub channels: Map<String, RefOr<Channel>>,
    /// An object to hold reusable [Operation Objects](Operation).
    #[serde(default, skip_serializing_if = "Map::is_empty")]
    pub operations: Map<String, RefOr<Operation>>,
    /// An object to hold reusable [Message Objects](Message).
    #[serde(default, skip_serializing_if = "Map::is_empty")]
    pub messages: Map<String, RefOr<Message>>,
    ...
    #[serde(default, skip_serializing_if = "Map::is_empty")]
    pub server_variables: Map<String, RefOr<Variable>>,
